...
import org.compass.core.marshall.*;
import org.compass.core.spi.AliasedObject;

/**
 * @author kimchy
 */
public class GridkitMarshallingStrategy implements MarshallingStrategy {
    ...
    public GridkitMarshallingStrategy(CompassMapping mapping, SearchEngine searchEngine,
                                      ConverterLookup converterLookup, ResourceFactory resourceFactory,
    ...
    private MarshallingContext createContext() {
        return new GridkitMarshallingContext(mapping, searchEngine, converterLookup, propertyNamingStrategy, this);
    }
}
