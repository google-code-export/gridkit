 ...
 * @author kimchy
 */
public class GridkitMarshallingContext implements MarshallingContext {
    ...
    public GridkitMarshallingContext(CompassMapping mapping, SearchEngine searchEngine,
                                     ConverterLookup converterLookup, PropertyNamingStrategy propertyNamingStrategy,
