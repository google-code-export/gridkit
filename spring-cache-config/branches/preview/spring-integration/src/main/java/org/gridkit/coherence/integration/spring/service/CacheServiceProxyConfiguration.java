 ...
 * 09.09.2010
 */
public class CacheServiceProxyConfiguration {

	@XmlConfigProperty("enabled")
	private Boolean enabled;
	
	@XmlConfigProperty("lock-enabled")
	private Boolean lockEnabled;
	
	@XmlConfigProperty("read-only")
	private Boolean readOnly;
	
	@XmlConfigProperty("class-name")
