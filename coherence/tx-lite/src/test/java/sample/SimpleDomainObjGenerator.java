...
public class SimpleDomainObjGenerator implements ObjectGenerator<DomainObjKey, DomainObject> {

    private int blobSize = 0;
    
    public SimpleDomainObjGenerator() {
    }
    
    public SimpleDomainObjGenerator(int blobSize) {
    ...
    private DomainObjAttrib makeAttr(int attrId, long i, Random rnd) {
        ...
        DomainObjAttrib attrib = blobSize == 0 ? new DomainObjAttrib() : new LargeDomainObjAttrib();
        ...
        if (blobSize > 0) {
            ...
            rnd.setSeed(i);
            rnd.nextBytes(data);
            ((LargeDomainObjAttrib)attrib).blob = data;
        }
