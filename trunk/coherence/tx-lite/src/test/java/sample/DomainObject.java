...
public class DomainObject implements Serializable {
    ...
    public DomainObjAttrib getA0_slow(int slowdown) {
    ...
    public String toString() {
        ...
        builder.append("DomainObject [id=").append(id).append(", a0=").append(a0).append(", a1=").append(a1).append(", a2=").append(a2).append(", a3=").append(a3).append("]");
