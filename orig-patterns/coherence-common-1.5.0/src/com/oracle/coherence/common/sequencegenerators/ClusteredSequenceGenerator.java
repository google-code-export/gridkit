...
public class ClusteredSequenceGenerator implements SequenceGenerator {
	...
	public Range next(long sequenceSize) {
		...
		long from = (Long)namedCache.invoke(sequenceName, new GenerateSequenceNumberProcessor(initialValue, sequenceSize));
	 ...
	 */
	@SuppressWarnings("serial")
	public static class GenerateSequenceNumberProcessor extends AbstractProcessor
