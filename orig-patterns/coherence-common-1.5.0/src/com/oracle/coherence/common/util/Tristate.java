...
public class Tristate implements ExternalizableLite, PortableObject {
	...
	public final static Tristate UNDEFINED = new Tristate((byte)-1);
	public final static Tristate FALSE = new Tristate((byte)0);
	public final static Tristate TRUE = new Tristate((byte)1);
