...
public class SshHostCustomizer extends JPanel {
  ...
  public static SshHostProperties defineHost() {
    ...
    final DialogDescriptor dd = new DialogDescriptor(sc, NbBundle.getMessage(
            SshHostCustomizer.class, "Title_Add_Remote_Host"), true, new Object[] {   // NOI18N
    ...
    if (dd.getValue() == hc.okButton) {
        SshHostProperties hp = new SshHostProperties(hc.getHostName(), hc.getDisplayName(),
  ...
  private static SshHostCustomizer getInstance() {
    if (instance == null) instance = new SshHostCustomizer();
    return instance;
  }
...
//                  prefSize.width = Math.min(prefSize.width, MAX_PROPERTIES_SIZE.width);
              ...
              Window w = SwingUtilities.getWindowAncestor(SshHostCustomizer.this);
              if (w != null) w.pack();
              update();
          }
      });
  ...
  private void initComponents() {
    ...
    Mnemonics.setLocalizedText(hostnameLabel, NbBundle.getMessage(SshHostCustomizer.class, "LBL_Host_name")); // NOI18N
    ...
    Mnemonics.setLocalizedText(displaynameCheckbox, NbBundle.getMessage(SshHostCustomizer.class, "LBL_Display_name")); // NOI18N
    ...
    Mnemonics.setLocalizedText(okButton, NbBundle.getMessage(
            SshHostCustomizer.class, "LBL_OK")); // NOI18N
