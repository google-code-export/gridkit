...
public class InstantiatedIndexWriter implements Closeable {
  ...
  public InstantiatedIndexWriter(InstantiatedIndex index, Analyzer analyzer, boolean create) {
    this.index = index;
 ...
 * @throws StaleReaderException 
   */
  public void commit() throws StaleReaderException, CorruptIndexException, LockObtainFailedException, IOException {
