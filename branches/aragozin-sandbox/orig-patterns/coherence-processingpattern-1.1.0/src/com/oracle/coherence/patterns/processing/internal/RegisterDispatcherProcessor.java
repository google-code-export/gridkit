/*
 * File: RegisterDispatcherProcessor.java
 * 
...
/**
 * <p>Register a {@link Dispatcher} with the system.</p>
 * 
 * @author Noah Arliss
 */
@SuppressWarnings("serial")
public class RegisterDispatcherProcessor extends AbstractProcessor 
	...
	/**
	 * Construct a new {@link RegisterDispatcherProcessor}. 
	 * 
	 * @param dispatcher  the dispatcher to register
	 */
	public RegisterDispatcherProcessor(Dispatcher dispatcher) {
	...
	public Object process(Entry entry) { 
		if (entry.isPresent()) {
			//TODO What should we do if this entry is already present?
			return null;
		} else {
			entry.setValue(dispatcher);
		}
		return null;
	}
