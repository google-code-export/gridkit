...
public class ContiguousRange implements Range, 
	...
	public int compareTo(Range other) {
	    if  ( 
	            (other instanceof ContiguousRange) &&
	...
	public String toString() {
		return isEmpty() ? "ContiguousRange[]" 
						 : isSingleton() ? String.format("ContiguousRange[%d]", from)
								 		 : String.format("ContiguousRange[%d..%d]", from, to);
	}
